...
engine_null_pool = create_async_engine(DB_URL, poolclass=NullPool)  # не содержит соединений, открыл - сразу закрыл

AsyncSession = async_sessionmaker(engine, expire_on_commit=False)  # возвращает одно соединение для работы с БД
